...
var oSpan3 = oBao.getElementsByTagName('span');
...
for(var n=0;n<oSpan3.length;n++){
	oSpan3[n].onclick = function (){
		for(var m=0;m<oSpan3.length;m++){
			oSpan3[m].style.color = '#656565';
			oSpan3[m].style.borderColor = '#D7D7D7';
		}
		this.style.color = '#D53F19';
		this.style.borderColor = '#D53F19';
	}
